...
const GearPanel: FC<GearPanelProps> = ({
  optionalDefs,
  setEnabledOptional,
  setValues,
  enabledOptional,
  ...
  const filteredOptional = optionalDefs.filter(
    (d) =>
      optionalSearch === '' ||
  ...
  return (
    <div className="gear-panel">
      ...
      <div className="gear-list">
        ...
        {filteredOptional.length === 0 && <span className="gear-empty">No matching fields.</span>}
      </div>
    </div>
  );
};
